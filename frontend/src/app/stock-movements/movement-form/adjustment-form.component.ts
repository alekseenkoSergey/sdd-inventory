...
import { MovementType, AdjustmentDirection, CreateStockMovementRequest, StockMovement } from '../../models/stock-movement.model';
    ...
    <div class="adjustment-form">
      ...
      <form [formGroup]="form" (ngSubmit)="onSubmit()">
        <div class="form-group">
          ...
          <div class="error-message" *ngIf="isFieldInvalid('direction')">
        ...
        <div class="form-actions">
          ...
          >
            {{ (loading$ | async) ? 'Submitting...' : 'Record Adjustment' }}
          </button>
          <button
            type="button"
...
export class AdjustmentFormComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.form = this.fb.group({
      direction: ['', [Validators.required, StockMovementValidators.adjustmentDirection()]],
  ...
  private updateQuantityValidators(direction: string): void {
    ...
    if (direction === AdjustmentDirection.DECREASE) {
      quantityControl.setValidators([
        Validators.required,
        StockMovementValidators.quantity(),
        StockMovementValidators.quantityMax(this.currentQuantity)
      ]);
    } else {
      quantityControl.setValidators([
        Validators.required,
  ...
  onSubmit(): void {
    ...
    const request: CreateStockMovementRequest = {
      ...
      adjustmentDirection: this.form.get('direction')?.value,
  ...
  getErrorMessage(fieldName: string): string {
    ...
    if (errors['maxValue']) {
      return `Quantity cannot exceed current stock of ${errors['maxValue'].max} units when decreasing`;
    }
    if (errors['invalidDirection']) {
      return 'Please select either Increase or Decrease';
    }
    if (errors['maxLength']) {
