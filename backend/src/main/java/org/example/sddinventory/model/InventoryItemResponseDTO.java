...
public class InventoryItemResponseDTO {
    ...
    public InventoryItemResponseDTO(Long id, String name, String description, String sku,
                                    Long categoryId, Long locationId, BigDecimal currentQuantity,
                                    String unit, BigDecimal lowStockThreshold, String status,
